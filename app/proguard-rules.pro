...
-keepnames class kotlin.reflect.jvm.internal.implementation.* { *; }

# 避免网络请求方法被混淆（去掉会导致网络请求解析异常）
-keep class com.android.easyApp.** { *; }
-keep class com.android.easyApp.utils.HandUtils$** { *; }