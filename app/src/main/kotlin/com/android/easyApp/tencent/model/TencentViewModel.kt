package com.android.easyApp.tencent.model

import android.app.Activity
import android.content.Intent
import androidx.lifecycle.ViewModel
import com.android.easyApp.state.GlobalState
import com.android.easyApp.tencent.helper.TencentLoginHelper
    ...
    private val loginHelper by lazy {
        TencentLoginHelper.create(
            ...
            onSuccess = { openId, token ->
                _loginState.value = TencentState.Success(openId, token)
            }
        )
    }
